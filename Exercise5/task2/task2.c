 ...
 * from the semaphores, but i couldn't figure out why. Also the programm delivers the solution
 * for N-1(I use the same code basis as in task1, but task1 works correctly).
 * 
 * 
 * Task1 is over 50 times faster: 
 * 
 * /usr/bin/time ./task2 100000 100000
The sum is: 4999950000
0.85user 1.23system 0:02.44elapsed 85%CPU (0avgtext+0avgdata 1092maxresident)


 /usr/bin/time ./task1 100000 100000
The sum is: 5000050000
0.01user 0.00system 0:00.03elapsed 48%CPU (0avgtext+0avgdata 1076maxresident)
 * 
 * 
 * 
